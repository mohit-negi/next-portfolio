...
type Props = {
  ...
  const Footer = ({ heroImageUrl }: Props) => {
        ...
        <div className="flex flex-col items-center justify-center">
          <Link href="#hero" className="mb-4">
            <Image
              width={48}
              height={48}
              className="h-12 w-12 rounded-full filter grayscale hover:grayscale-0 transition-all duration-300"
              src={heroImageUrl}
              alt="Profile"
            />
          </Link>
          ...
          <div className="text-sm text-center">
            ...
            <p className="mt-1">Web Developer based in Your Location</p>
          </div>
        </div>
      </div>
    </footer>
